...
<div class="page-header">
    <div class="add-item d-flex">
        <div class="page-title">
            <h4 class="fw-bold">Add Testimonial</h4>
        </div>
    </div>
    <div class="page-btn mt-0">
        <a href="{{ route('testimonial') }}" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to
            Testimonial</a>
    </div>
</div>
<form action="{{ route('testimonial.store') }}" method="POST" class="add-product-form" enctype="multipart/form-data">
    @csrf
                ...
                <h2 class="accordion-header">
                    <div class="accordion-button collapsed bg-primary">
                        <div class="d-flex align-items-center justify-content-between flex-fill">
                            <h5 class="d-flex align-items-center text-light"><span>Add Testimonial</span></h5>
                        </div>
                    </div>
                </h2>
                @if ($errors->any())
