...
@section('content')
    ...
    <form action="{{ route('category.update') }}" method="POST" class="add-product-form" enctype="multipart/form-data">
        @csrf
                    ...
                    <h2 class="accordion-header">
                        <div class="accordion-button collapsed bg-primary">
                            <div class="d-flex align-items-center justify-content-between flex-fill">
                                <h5 class="d-flex align-items-center text-light"><span>Edit Category</span></h5>
                            </div>
                        </div>
                    </h2>
                                ...
                                <div class="text-editor add-list add">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="add-choosen">
                                            ...
                                            <div class="phone-img">
                                                <img src="{{ url('public/uploads/category/' . $category->image) ? url('public/uploads/category/' . $category->image) : asset('assets/images/noimage.png') }}"
                                                    alt="image">
                                ...
                                <div class="col-sm-12 col-12">
                                    <div class="mb-4 mt-4">
                                        ...
                                        <div class="form-check form-check-lg form-switch">
                                            <input class="form-check-input" type="checkbox" name="status" role="switch" id="switch-lg"
                                                value="{{ old('status', $category->status ?? 0) == 1 ? '1' : '0' }}"
