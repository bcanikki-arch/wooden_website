...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3 bg-primary">
            <div>
                <h4 class="text-light">Stock List</h4>
            </div>           
        </div>
    ...
    <script>   
        ...
        var stockTable = $('#stock_table').DataTable({
            ...
            columns: [
                ...
                { data: 'totals', name: 'totals',orderable: false,searchable: true},
                // { data: 'solds', name: 'solds',orderable: false,searchable: true},
                // { data: 'res', name: 'res',orderable: false,searchable: true},
        ...
        //     $.ajax({
        //         url: 'stock/update-status/' + stockId, 
        //         type: 'POST',
        //         data: {
        //             _token: '{{ csrf_token() }}',
        //             status: nextStatus 
        ...
        //             if (response.success) {
        //                 $('#stock_table').DataTable().ajax.reload(null, false); 
        //             } else {                     
