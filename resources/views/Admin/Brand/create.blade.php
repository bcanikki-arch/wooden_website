...
@section('content')
    ...
    <form action="{{ route('brand.store') }}" method="POST" class="add-product-form" enctype="multipart/form-data">
        @csrf
                    ...
                    <h2 class="accordion-header">
                        <div class="accordion-button collapsed bg-primary">
                            <div class="d-flex align-items-center justify-content-between flex-fill">
                                <h5 class="d-flex align-items-center text-light"><span>Add Brand </span></h5>
                            </div>
                        </div>
                    </h2>
